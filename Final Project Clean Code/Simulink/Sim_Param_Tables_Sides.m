...
function [leg1_alpha, leg2_alpha, leg3_alpha, leg4_alpha, ...
    ...
    Sim_Param_Tables_Sides(alphaDeg,betaDeg,gammaDeg,p,coxa,femur,tibia)
%% "Given" Information
% o = [0; 0; 6; 30; 0; 0];
% 
...
leg2_alpha = timetable(-[alpha(2,:).'; alpha(2,:).';alpha(2,:).']-90, 'rowTimes', secondtime);
leg3_alpha = timetable(-[alpha(3,:).'; alpha(3,:).';alpha(3,:).']-90, 'rowTimes', secondtime);
leg4_alpha = timetable(-[alpha(4,:).'; alpha(4,:).'; alpha(4,:).']-90, 'rowTimes', secondtime);
