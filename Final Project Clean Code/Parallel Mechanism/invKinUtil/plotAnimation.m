...
% mechanism and saves it as a gif. Front legs are light blue, back are dark blue
%
% Input: trajectPositions - list of trajectory positions (3xtimestep) each
%                           row is xyz
%         listOfJntPosLeg1 - list of all of leg 1's joint positions rows
%                           1:3 are hip, 4:6 are knee, 7:9 are ankle (foot
%                           positions remain for parallel mechanisms)
%         listOfJntPosLeg2 - list of all of leg 2's joint positions rows
%                           1:3 are hip, 4:6 are knee, 7:9 are ankle (foot
%                           positions remain for parallel mechanisms)
%         listOfJntPosLeg3 - list of all of leg 3's joint positions rows
%                           1:3 are hip, 4:6 are knee, 7:9 are ankle (foot
%                           positions remain for parallel mechanisms)
%         listOfJntPosLeg4- list of all of leg 4's joint positions rows
%                           1:3 are hip, 4:6 are knee, 7:9 are ankle (foot
%                           positions remain for parallel mechanisms)
%         UHome - matrix of U vectors for each leg (3x4 - rows are xyz, columns
