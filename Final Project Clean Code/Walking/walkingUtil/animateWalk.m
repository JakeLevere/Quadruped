...
% This function plots the animation of the walking robot and saves it as a
% gif. Leg 1 is red, leg 2 is green, leg 3 is dark blue, leg 4 is light
% blue.
%
% Input:timeMat - time matrix of one cycle
%         listOfJntPosLeg1- list of leg 1's joint positions during the
%                       full cycle
%         listOfJntPosLeg2- list of leg 2's joint positions during the
%                       full cycle
%         listOfJntPosLeg3- list of leg 3's joint positions during the
%                       full cycle
%         listOfJntPosLeg4 - list of leg 4's joint positions during the
%                       full cycle
...
%         limits - 3x2 matrix indicating the upper and lower limits of the
%                   axes of the plot
