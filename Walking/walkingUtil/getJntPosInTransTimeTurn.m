%%  for turning get the joint positions of the legs during the tranfer time


function[transTimeJntPosLeg1,transTimeJntPosLeg2,transTimeJntPosLeg3,transTimeJntPosLeg4] = getJntPosInTransTimeTurn(Alpha,Beta,Gamma,coxa,femur,tibia, xb_g, yb_g,zb_g)
...
%     kneePos1 = kneePos_b1+hipPos1;
%     kneePos2 = kneePos_b2+hipPos2;
%     kneePos3 = kneePos_b3+hipPos3;
%     kneePos4 = kneePos_b4+hipPos4;
%     % ankle Positions
%     anklePos1 = anklePos_b1+hipPos1;
%     anklePos2 = anklePos_b2+hipPos2;
%     anklePos3 = anklePos_b3+hipPos3;
%     anklePos4 = anklePos_b4+hipPos4;
%     %Foot Positions
%     footPos1 = footPos_b1+hipPos1;
%     footPos2 = footPos_b2+hipPos2;
%     footPos3 = footPos_b3+hipPos3;
%     footPos4 = footPos_b4+hipPos4;
