%% Trajectory animation of parallel movements walking robot
clc; clear all; close all;
%% Initial Positions, angles and values
homePose = [0;0; 5.7477;0;0;0];
[AlphaiHome,BetaiHome,GammaiHome,UHome, ~,~,~] = InverseKinematicsParallelWalkingV2(homePose, 'XYZ', true);
...
[AlphaiGoal,BetaiGoal,GammaiGoal,~,~,~,~] = InverseKinematicsParallelWalkingV2(goalPose, 'XYZ', true);
...
%% plot animation
plotAnimation(listOfPoses(1:3,:),listOfJntPosLeg1,listOfJntPosLeg2,listOfJntPosLeg3,listOfJntPosLeg4, UHome,'Stickplot Animation','home_pos_to_upper.gif')
